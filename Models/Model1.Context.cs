...
namespace TeachImageWebsite.Models
{
    ...
    public partial class projectsqlEntities1 : DbContext
    {
        public projectsqlEntities1()
            : base("name=projectsqlEntities1")
        {
        }
        ...
        public virtual DbSet<FollowMember> FollowMember { get; set; }
